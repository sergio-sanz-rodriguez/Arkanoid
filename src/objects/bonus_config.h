...
namespace bonus_config {
    ...
    inline constexpr std::array<std::array<float, 5>, 9> level_probs{ {
            ...
            {  0.55f,   0.45f,   0.50f, 0.15f,  0.35f }  // Level 9

            //{  0.0f,   1.0f,   0.0f, 1.0f,  0.0f }, // Level 1
            //{  0.0f,   1.0f,   0.0f, 1.0f,  0.0f }, // Level 2
            //{  0.0f,   1.0f,   0.0f, 1.0f,  0.0f }, // Level 3
            //{  0.0f,   1.0f,   0.0f, 1.0f,  0.0f }, // Level 4
            //{  0.0f,   1.0f,   0.0f, 1.0f,  0.0f }, // Level 5
            //{  0.0f,   1.0f,   0.0f, 1.0f,  0.0f }, // Level 6
            //{  0.0f,   1.0f,   0.0f, 1.0f,  0.0f }, // Level 7
            //{  0.0f,   1.0f,   0.0f, 1.0f,  0.0f }, // Level 8
            //{  0.55f,   0.45f,   0.0f, 0.15f,  0.35f }  // Level 9
        } };
